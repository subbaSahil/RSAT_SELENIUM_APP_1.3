...
# Inputting into: QuickFilterControl
        ...
        if(Interactions.check_element_exist(driver, By.XPATH, "//input[contains(@name,'QuickFilterControl')]")):
            ...
            Interactions.fail_test_case(base.steps_count,"Use the Quick Filter to find records. For example, filter on the Product number field with a value of '0007'.","Send Keys")
        base.steps_count += 1
        Interactions.log_interaction(base.steps_count, "Validate that the value for 'Product number' is :''", "Validate 'Product number' field for 'current value'", "", "")
        print("Validation step logged for: Product number , value : ")
# Clicking button: ListPageGrid
        ...
        base.steps_count += 1
        Interactions.log_interaction(base.steps_count, "Validate that the value for 'Title' is :''", "Validate 'Title' field for 'current value'", "", "")
        print("Validation step logged for: Title , value : ")
# Closing the page
        base.steps_count +=1
